        ...
        >
          <div className="flex flex-col items-center mt-2">
            <motion.div
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white text-black font-extrabold text-4xl shadow-none"
            >
      ...
      >
        <div className="space-y-4">
          <div>
            ...
            >
              <AnimatedCount to={6} />+ Contributors
            </motion.div>
